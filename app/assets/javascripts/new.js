...
$(function() {
  $(".items-sell__price").on("keyup", function() {
    var input = ($(".items-sell__price__right__list1__plices__example").val());
    var commission = input * 0.1;
    var profits = input - commission;

    $(".commision").children('.items-sell__price__right__list2__last').text("￥" + commission);
    $(".profits").children('.items-sell__price__right__list3__last').text("￥" + profits);
  });
});
